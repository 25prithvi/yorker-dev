...
../Core/Platform/Src/platform_flashstorage.c \
...
./Core/Platform/Src/platform_flashstorage.o \
...
./Core/Platform/Src/platform_flashstorage.d \
...
Core/Platform/Src/platform_flashstorage.o: ../Core/Platform/Src/platform_flashstorage.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DDEBUG -DSTM32F429xx -c -I../Core/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F4xx/Include -I../Drivers/CMSIS/Include -I../Core/Platform/Inc -I../Core/Display/Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Platform/Src/platform_flashstorage.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
